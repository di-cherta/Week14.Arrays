...
const myInformation = ['Диана', 15, 7, 'рак'];
...
const countries = ['Austria', 'Belgium', 'Netherlands', 'Czechia', 'Croatia'];
...
const russianCities = [...newCities, 'Казань', 'Нижний Новгород'];
...
function filterEvenNumbers(){
    const newNumbers = numbers.filter((elem) => elem%2 === 0);
    return newNumbers;
}
...
const randomNumbers = [72, 45, 19, 84, 37, 56, 91, 23, 68, 10, 98, 32];
